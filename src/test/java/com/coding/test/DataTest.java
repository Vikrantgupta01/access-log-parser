...
public class DataTest {
    ...
    public void testParsing() {
        ...
        List<String> datas = Arrays.asList("177.71.128.21 - - [10/Jul/2018:22:21:28 +0200] \"GET /intranet-analytics/ HTTP/1.1\" 200 3574 \"-\" \"Mozilla/5.0 (X11; U; Linux x86_64; fr-FR) AppleWebKit/534.7 (KHTML, like Gecko) Epiphany/2.30.6 Safari/534.7\"\n",
        ...
        List<AccessLogData> accessLogData = new AccessLogDataProcessorImpl().parserData(datas);
    ...
    @Test
    public void testParsingProcessing() {
        ...
        assertEquals("/blog/2018/08/survey-your-opinion-matters/", result.getMostActiveUrls().get(0), "Most active url is not correct");
    }
}
